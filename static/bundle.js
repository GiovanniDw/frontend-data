...
var drawProvinceNL = /*#__PURE__*/function () {
  ...
  return function drawProvinceNL(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
Object.defineProperty(exports, "drawPenR", {
  enumerable: true,
  get: function get() {
    return _drawPenR.drawPenR;
  }
});
Object.defineProperty(exports, "drawProvinceNL", {
  enumerable: true,
  get: function get() {
...
function getCSVData(_x3) {
  return _getCSVData.apply(this, arguments);
}

function _getCSVData() {
  _getCSVData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(url) {
    var _data;
...
function getData(url, endPoint) {
  return (0, _d2.json)(url + endPoint).then(data.results.bindings);
}

function getLocalData(url) {
  return (0, _d2.json)(url).then();
}
...
var toObject = function toObject(arr, key) {
  return arr.reduce(function (a, b) {
    return _objectSpread(_objectSpread({}, a), {}, _defineProperty({}, b[key], b));
  }, {});
};
